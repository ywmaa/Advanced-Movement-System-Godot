...
var light_on_sound =  preload("res://AMSG_Examples/Player/flashlight/light_on.wav")
var light_off_sound =  preload("res://AMSG_Examples/Player/flashlight/light_off.wav")
var can_use = true
